...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result && $result->num_rows == 1) {
        ...
        if ($passwordMatch) {
            ...
            $roleQuery = "SELECT DoctorID AS role_id FROM doctor WHERE UserID = {$user['UserID']}";
        ...
        $error = "No doctor found with those credentials!";
    }
}
?>
...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            background: url('../images/doctor_bg3.png') no-repeat center center;
...
<body>
    ...
    <div class="login-box">
        <img src="../images/doctor1.png" class="top-img" alt="Doctor">
        <h2>Good day, Doc!<br><span style="font-size: 18px;">Welcome!</span></h2>
        <form method="POST">
