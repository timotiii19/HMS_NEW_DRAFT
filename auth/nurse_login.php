...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM users WHERE email = '$email' AND role = 'Nurse'";
    ...
    if ($result && $result->num_rows == 1) {
        ...
        if ($passwordMatch) {
            ...
            $roleQuery = "SELECT NurseID AS role_id FROM nurse WHERE UserID = {$user['UserID']}";
        ...
        $error = "No Nurse found with those credentials!";
    }
}
?>
