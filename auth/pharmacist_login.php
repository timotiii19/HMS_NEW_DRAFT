...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM users WHERE email = '$email' AND role = 'Pharmacist'";
    ...
    if ($result && $result->num_rows == 1) {
        ...
        if ($passwordMatch) {
            ...
            $roleQuery = "SELECT PharmacistID AS role_id FROM pharmacist WHERE UserID = {$user['UserID']}";
