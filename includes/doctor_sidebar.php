<div class="sidebar" id="sidebar">
  ...
  <ul>
    ...
    <li><a href="/HMS-main/views/doctors/appointments.php"><i class="fa fa-chart-line"></i><span class="label">Patient Confirmation</a></li>
    ...
    <li><a href="/HMS-main/views/doctors/labprocedure.php"><i class="fa fa-chart-line"></i><span class="label">Laboratory Procedure</span></a></li>
